...
class QQMusicLyricDecoder {
  ...
  static String? _extractMappedLyricContent(
    String xmlLikeText,
    String tagName,
  ) {
  ...
  static Uint8List _inversePermutation(int s0, int s1) {
    ...
    const mappings = <({int byteIndex, int bitIndex, int shift, bool useS0})>[
      (byteIndex: 3, bitIndex: 7, shift: 7, useS0: false),
      (byteIndex: 3, bitIndex: 7, shift: 6, useS0: true),
      (byteIndex: 3, bitIndex: 15, shift: 5, useS0: false),
      (byteIndex: 3, bitIndex: 15, shift: 4, useS0: true),
      (byteIndex: 3, bitIndex: 23, shift: 3, useS0: false),
      (byteIndex: 3, bitIndex: 23, shift: 2, useS0: true),
      (byteIndex: 3, bitIndex: 31, shift: 1, useS0: false),
      (byteIndex: 3, bitIndex: 31, shift: 0, useS0: true),
      (byteIndex: 2, bitIndex: 6, shift: 7, useS0: false),
      (byteIndex: 2, bitIndex: 6, shift: 6, useS0: true),
      (byteIndex: 2, bitIndex: 14, shift: 5, useS0: false),
      (byteIndex: 2, bitIndex: 14, shift: 4, useS0: true),
      (byteIndex: 2, bitIndex: 22, shift: 3, useS0: false),
      (byteIndex: 2, bitIndex: 22, shift: 2, useS0: true),
      (byteIndex: 2, bitIndex: 30, shift: 1, useS0: false),
      (byteIndex: 2, bitIndex: 30, shift: 0, useS0: true),
      (byteIndex: 1, bitIndex: 5, shift: 7, useS0: false),
      (byteIndex: 1, bitIndex: 5, shift: 6, useS0: true),
      (byteIndex: 1, bitIndex: 13, shift: 5, useS0: false),
      (byteIndex: 1, bitIndex: 13, shift: 4, useS0: true),
      (byteIndex: 1, bitIndex: 21, shift: 3, useS0: false),
      (byteIndex: 1, bitIndex: 21, shift: 2, useS0: true),
      (byteIndex: 1, bitIndex: 29, shift: 1, useS0: false),
      (byteIndex: 1, bitIndex: 29, shift: 0, useS0: true),
      (byteIndex: 0, bitIndex: 4, shift: 7, useS0: false),
      (byteIndex: 0, bitIndex: 4, shift: 6, useS0: true),
      (byteIndex: 0, bitIndex: 12, shift: 5, useS0: false),
      (byteIndex: 0, bitIndex: 12, shift: 4, useS0: true),
      (byteIndex: 0, bitIndex: 20, shift: 3, useS0: false),
      (byteIndex: 0, bitIndex: 20, shift: 2, useS0: true),
      (byteIndex: 0, bitIndex: 28, shift: 1, useS0: false),
      (byteIndex: 0, bitIndex: 28, shift: 0, useS0: true),
      (byteIndex: 7, bitIndex: 3, shift: 7, useS0: false),
      (byteIndex: 7, bitIndex: 3, shift: 6, useS0: true),
      (byteIndex: 7, bitIndex: 11, shift: 5, useS0: false),
      (byteIndex: 7, bitIndex: 11, shift: 4, useS0: true),
      (byteIndex: 7, bitIndex: 19, shift: 3, useS0: false),
      (byteIndex: 7, bitIndex: 19, shift: 2, useS0: true),
      (byteIndex: 7, bitIndex: 27, shift: 1, useS0: false),
      (byteIndex: 7, bitIndex: 27, shift: 0, useS0: true),
      (byteIndex: 6, bitIndex: 2, shift: 7, useS0: false),
      (byteIndex: 6, bitIndex: 2, shift: 6, useS0: true),
      (byteIndex: 6, bitIndex: 10, shift: 5, useS0: false),
      (byteIndex: 6, bitIndex: 10, shift: 4, useS0: true),
      (byteIndex: 6, bitIndex: 18, shift: 3, useS0: false),
      (byteIndex: 6, bitIndex: 18, shift: 2, useS0: true),
      (byteIndex: 6, bitIndex: 26, shift: 1, useS0: false),
      (byteIndex: 6, bitIndex: 26, shift: 0, useS0: true),
      (byteIndex: 5, bitIndex: 1, shift: 7, useS0: false),
      (byteIndex: 5, bitIndex: 1, shift: 6, useS0: true),
      (byteIndex: 5, bitIndex: 9, shift: 5, useS0: false),
      (byteIndex: 5, bitIndex: 9, shift: 4, useS0: true),
      (byteIndex: 5, bitIndex: 17, shift: 3, useS0: false),
      (byteIndex: 5, bitIndex: 17, shift: 2, useS0: true),
      (byteIndex: 5, bitIndex: 25, shift: 1, useS0: false),
      (byteIndex: 5, bitIndex: 25, shift: 0, useS0: true),
      (byteIndex: 4, bitIndex: 0, shift: 7, useS0: false),
      (byteIndex: 4, bitIndex: 0, shift: 6, useS0: true),
      (byteIndex: 4, bitIndex: 8, shift: 5, useS0: false),
      (byteIndex: 4, bitIndex: 8, shift: 4, useS0: true),
      (byteIndex: 4, bitIndex: 16, shift: 3, useS0: false),
      (byteIndex: 4, bitIndex: 16, shift: 2, useS0: true),
      (byteIndex: 4, bitIndex: 24, shift: 1, useS0: false),
      (byteIndex: 4, bitIndex: 24, shift: 0, useS0: true),
    ];
  ...
  static int _f(int state, List<int> key) {
    ...
    final newState =
        ((_sbox[0][_sboxBit(lrgstate[0] >> 2)] << 28) |
            (_sbox[1][_sboxBit(
                  ((lrgstate[0] & 0x03) << 4) | (lrgstate[1] >> 4),
                )] <<
                24) |
            (_sbox[2][_sboxBit(
                  ((lrgstate[1] & 0x0F) << 2) | (lrgstate[2] >> 6),
                )] <<
                20) |
            (_sbox[3][_sboxBit(lrgstate[2] & 0x3F)] << 16) |
            (_sbox[4][_sboxBit(lrgstate[3] >> 2)] << 12) |
            (_sbox[5][_sboxBit(
                  ((lrgstate[3] & 0x03) << 4) | (lrgstate[4] >> 4),
                )] <<
                8) |
            (_sbox[6][_sboxBit(
                  ((lrgstate[4] & 0x0F) << 2) | (lrgstate[5] >> 6),
                )] <<
                4) |
