          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    'Use Standard Lyrics for Translation Pairing',
                    style: TextStyle(
                      color: Colors.white70,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    'Use discrete lines instead of rich lyrics to pair translations. Recommended if rich lyrics have poor alignment with translations.',
                    style: TextStyle(
                      color: Colors.white38,
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    'Note: QQMusic will always use discrete lines for translation pairing.',
                    style: TextStyle(
                      color: Colors.white38,
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                  ...
                  Column(
                    children:
                        [
                          ...
                          final isSelected = provider
                              .useStandardLyricsForPairingProviders
                              .current
                              .contains(providerType);
                          return Padding(
                            padding: const EdgeInsets.only(bottom: 8.0),
                            child: GestureDetector(
                              onTap: () {
                                ...
                                provider
                                    .setUseStandardLyricsForPairingProviders(
                                      updated,
                                    );
                              },
                              child: Row(
